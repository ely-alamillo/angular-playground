...
exports.getSetoid = function (S) {
    ...
    return {
        equals: function (x) { return function (y) { return sub(x)(y) && sub(y)(x); }; }
    };
};
/** @function */
...
exports.member = function (S) { return function (x) { return function (a) {
    return exports.some(S.equals(a))(x);
}; }; };
/**
 * Form the union of two sets
 * @function
 */
exports.union = function (x) { return function (y) {
    var r = new Set(x);
    y.forEach(function (e) { return r.add(e); });
    return r;
}; };
/**
...
/** @function */
exports.getUnionMonoid = function () {
    return {
        concat: exports.union,
        empty: function () { return emptySet; }
    };
};
/** @function */
...
exports.reduce = function (f, b, fa) {
    return exports.toArray(fa).reduce(f, b);
};
/**
 ...
 * @function
 */
exports.insert = function (a) { return function (x) {
    var r = new Set(x);
    r.add(a);
    return r;
}; };
...
exports.remove = function (S) { return function (a) { return function (x) {
    return exports.filter(function_1.not(S.equals(a)))(x);
}; }; };
