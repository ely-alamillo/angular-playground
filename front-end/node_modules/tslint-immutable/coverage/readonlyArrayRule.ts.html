...
<html lang="en">
<head>
    <title>Code coverage report for readonlyArrayRule.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> readonlyArrayRule.ts
    </h1>
    <div class='clearfix'>
...
function checkArrayTypeOrReference(
  ...
  if (
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (node.kind === ts.SyntaxKind.TypeReference) {
      const typeNode = node as ts.TypeReferenceNode;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeNode.typeArguments) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Dec 29 2017 19:39:54 GMT+0100 (CET)
</div>
</div>
